...
public:
	...
	static Compiler::value add_eq_mpz_mpz(Compiler& c, std::vector<Compiler::value> args, int);
	...
	static Compiler::value mul_eq_mpz_int(Compiler& c, std::vector<Compiler::value> args, int);
