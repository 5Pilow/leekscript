#ifndef META_CONCAT_TYPE_HPP
#define META_CONCAT_TYPE_HPP

#include "Type.hpp"

namespace ls {

class Meta_concat_type : public Type {
public:
	const Type* t1;
	const Type* t2;
	Meta_concat_type(const Type* t1, const Type* t2) : Type(t1->env), t1(t1), t2(t2) {}
