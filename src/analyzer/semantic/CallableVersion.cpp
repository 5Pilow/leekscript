...
CallableVersion::CallableVersion(std::string name, const Type* type, std::vector<const TypeMutator*> mutators, std::vector<const Type*> templates, bool object, bool unknown, bool v1_addr, bool v2_addr, int flags)
...
#if COMPILER
CallableVersion::CallableVersion(std::string name, const Type* type, std::function<Compiler::value(Compiler&, std::vector<Compiler::value>, int)> func, std::vector<const TypeMutator*> mutators, std::vector<const Type*> templates, bool object, bool unknown, bool v1_addr, bool v2_addr, int flags)
...
CallableVersion::CallableVersion(std::string name, const Type* type, void* addr, std::vector<const TypeMutator*> mutators, std::vector<const Type*> templates, bool object, bool unknown, bool v1_addr, bool v2_addr, int flags)
	...
	#endif
	{}
CallableVersion::CallableVersion(std::string name, const Type* type, const Value* value, std::vector<const TypeMutator*> mutators, std::vector<const Type*> templates, bool object, bool unknown, bool v1_addr, bool v2_addr, int flags)
	...
	#endif
	{}
CallableVersion::CallableVersion(std::string name, const Type* type, FunctionVersion* f, std::vector<const TypeMutator*> mutators, std::vector<const Type*> templates, bool object, bool unknown, bool v1_addr, bool v2_addr, int flags)
...
CallableVersion::CallableVersion(const Type* return_type, std::initializer_list<const Type*> arguments, void* addr, int flags, std::vector<const TypeMutator*> mutators)
	: type(Type::fun(return_type, arguments)), symbol(true), mutators(mutators), flags(flags), addr(addr)
	#if COMPILER
	, extra_arg(return_type->env)
	#endif
	{}
#if COMPILER
CallableVersion::CallableVersion(const Type* return_type, std::initializer_list<const Type*> arguments, std::function<Compiler::value(Compiler&, std::vector<Compiler::value>, int)> func, int flags, std::vector<const TypeMutator*> mutators)
	: type(Type::fun(return_type, arguments)), func(func), mutators(mutators), flags(flags), extra_arg(return_type->env) {}
#endif

CallableVersion::CallableVersion(const Type* v1_type, const Type* v2_type, const Type* return_type, void* addr, int flags, std::vector<const TypeMutator*> mutators, bool v1_addr, bool v2_addr)
	...
	#if COMPILER
	, extra_arg(v1_type->env)
	#endif
	{}
#if COMPILER
CallableVersion::CallableVersion(const Type* v1_type, const Type* v2_type, const Type* return_type, std::function<Compiler::value(Compiler&, std::vector<Compiler::value>, int)> func, int flags, std::vector<const TypeMutator*> mutators, bool v1_addr, bool v2_addr)
