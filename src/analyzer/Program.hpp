...
public:
	 ...
	 */
	#if COMPILER
	VM::Result compile(VM& vm, Context* context = nullptr, bool debug = false, bool assembly = false, bool pseudo_code = false, bool optimized_ir = false, bool ir = false, bool bitcode = false);
	VM::Result compile_leekscript(VM& vm, Context* ctx, bool debug, bool assembly, bool pseudo_code, bool optimized_ir);
